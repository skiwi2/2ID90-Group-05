...
public class MyDraughtsPlugin extends DraughtsPlayerProvider implements DraughtsPlugin {
    public MyDraughtsPlugin() {
        ...
        super(new UninformedPlayer(), new OptimisticPlayer(), new StupidPlayer(), new AIPlayerNoHeuristic(), new AIPlayerSimpleHeuristic(), new AIPlayerAdvancedHeuristic(), new AIPlayerAdvancedHeuristic(), new AIPlayerPositionHeuristic(), new AIPlayerPositionHeuristic());
    }
}
